    ...
    public sealed class IniFile
    {
        ...
        public IniFile(string filePath, IniReadErrorEventHandler IniReadErrorCallback)
        {
            ...
            if (System.IO.File.Exists(filePath))
                ...
                using (System.IO.StreamReader theReader = new System.IO.StreamReader(fs))
        ...
        public void Save(System.Text.Encoding encode)
        {
            ...
            using (System.IO.FileStream fs = System.IO.File.Create(this.sFilename))
            using (System.IO.StreamWriter theWriter = new System.IO.StreamWriter(fs, encode))
            {
